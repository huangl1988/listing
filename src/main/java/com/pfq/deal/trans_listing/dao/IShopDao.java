...
//-----
	...
	void commodyUp(@Param("id") Long commodyId);

	void up(@Param("id")Integer shopId);

	void commodyDown (@Param("id")Long commodyId,@Param("shopId")Integer shopId);

	void down(@Param("id") Integer shopId);
}
